      ...
      <div class="row pr-3">
        <div id="preview" class="col pr-0">
          <div class="card bg-transparent mr-5 position-absolute">
            <img
              class="card-img-top"
              src="/img/product/md/57e3b072N661cd00d.jpg"
              alt="Card image cap"
            />
            ...
            <div
              ...
              style="background-image:url(/img/product/lg/57e3b072N661cd00d.jpg)"
            ></div>
              ...
              <div class="d-inline-block pt-2 mx-0 m-auto">
                ...
                <ul class="list-unstyled mb-0" style="width: 434px; margin-left:-62px">
                  <li class="float-left p-1">
                    <img
                      src="/img/product/sm/57e3b072N661cd00d.jpg"
                      data-md="/img/product/md/57e3b072N661cd00d.jpg"
                      data-lg="/img/product/lg/57e3b072N661cd00d.jpg"
                    />
                  </li>
                  <li class="float-left p-1">
                    <img
                      src="/img/product/sm/57e1ff09Nf610fea3.jpg"
                      data-md="/img/product/md/57e1ff09Nf610fea3.jpg"
                      data-lg="/img/product/lg/57e1ff09Nf610fea3.jpg"
                    />
                  </li>
                  <li class="float-left p-1">
                    <img
                      src="/img/product/sm/57e1ff17N286390a9.jpg"
                      data-md="/img/product/md/57e1ff17N286390a9.jpg"
                      data-lg="/img/product/lg/57e1ff17N286390a9.jpg"
                    />
                  </li>
                  <li class="float-left p-1">
                    <img
                      src="/img/product/sm/57e1ff2fN8a36d0fe.jpg"
                      data-md="/img/product/md/57e1ff2fN8a36d0fe.jpg"
                      data-lg="/img/product/lg/57e1ff2fN8a36d0fe.jpg"
                    />
                  </li>
                  <li class="float-left p-1">
                    <img
                      src="/img/product/sm/57e52dffNa4d8ce2c.jpg"
                      data-md="/img/product/md/57e52dffNa4d8ce2c.jpg"
                      data-lg="/img/product/lg/57e52dffNa4d8ce2c.jpg"
                    />
                  </li>
                  <li class="float-left p-1">
                    <img
                      src="/img/product/sm/57e52e03N4ec367dd.jpg"
                      data-md="/img/product/md/57e52e03N4ec367dd.jpg"
                      data-lg="/img/product/lg/57e52e03N4ec367dd.jpg"
                    />
                  </li>
                  <li class="float-left p-1">
                    <img
                      src="/img/product/sm/57e52e06N116974f7.jpg"
                      data-md="/img/product/md/57e52e06N116974f7.jpg"
                      data-lg="/img/product/lg/57e52e06N116974f7.jpg"
                    />
                  </li>
                </ul>
              </div>
        ...
        <div id="details" class="col pl-0">
          ...
          >Apple MacBook Air 13.3英寸笔记本 银色(Core i5 处理器/8GB内存/128GB SSD闪存 MMGF2CH/A)</h6>
          <h6>
            <a
              class="small text-dark font-weight-bold"
              href="javascript:;"
            >5月焕新季，领券买新机！神券满6000减600！一体成型金属机身，纤薄轻巧，长达12小时续航</a>
          </h6>
          ...
          <div>
            ...
            <div class="float-left w-75">
              ...
              >双核i5/8GB内存/128GB闪存</a>
              <a
                class="btn btn-sm btn-outline-secondary"
                href="product_details.html?lid=2"
              >双核i5/8GB内存/256GB闪存</a>
              <a
                class="btn btn-sm btn-outline-secondary"
                href="product_details.html?lid=3"
              >定制款：双核i7/8G内存/128G闪存</a>
              <a
                class="btn btn-sm btn-outline-secondary"
                href="product_details.html?lid=4"
              >定制款：双核i7/8G内存/256G闪存</a>
            </div>
          ...
          <div class="pl-3">
            <ul class="list-unstyled">
              <li class="float-left mb-2">
                <a class="text-muted small" href="#">商品名称：AppleMacBook Air</a>
              </li>
              <li class="float-left mb-2">
                <a class="text-muted small" href="#">系统：MacOS</a>
              </li>
              <li class="float-left mb-2">
                <a class="text-muted small" href="#">内存容量：8G</a>
              </li>
              <li class="float-left mb-2">
                <a class="text-muted small" href="#">分辨率：1920*1080</a>
              </li>
              <li class="float-left mb-2">
                <a class="text-muted small" href="#">显卡型号：集成显卡</a>
              </li>
              <li class="float-left mb-2">
                <a class="text-muted small" href="#">处理器：Intel i5低功耗版</a>
              </li>
              <li class="float-left mb-2">
                <a class="text-muted small" href="#">显存容量：其它</a>
              </li>
              <li class="float-left mb-2">
                <a class="text-muted small" href="#">分类：轻薄本</a>
              </li>
              <li class="float-left mb-2">
                <a class="text-muted small" href="#">硬盘容量:128G固态</a>
              </li>
            </ul>
          </div>
          <a name="商品介绍"></a>
